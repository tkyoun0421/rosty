...
- [ ] 관리자가 근무일과 역할/인원을 포함한 스케줄을 생성하고 모집 상태를 운영할 수 있어야 한다.
- [ ] 근무자가 모집 중인 근무를 보고 신청할 수 있어야 한다.
- [ ] 관리자가 신청자를 검토하고 역할별로 배정 및 확정할 수 있어야 한다.
- [ ] 근무자가 확정된 근무와 예상 급여를 확인할 수 있어야 한다.
- [ ] 근무자가 위치 기반 출근 체크를 제출할 수 있어야 한다.
...
---
*Last updated: 2026-03-31 after Phase 1 completion and Phase 2 context capture*