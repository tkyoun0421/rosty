...
**Plans**: 3
Plans:
- [x] 02-01-PLAN.md - Minimal schedule persistence, atomic admin creation path, and create-first admin route
- [x] 02-02-PLAN.md - Admin schedule listing and lightweight status management
- [x] 02-03-PLAN.md - Worker recruiting list and one-application-per-schedule submit flow
**Status**: Complete
