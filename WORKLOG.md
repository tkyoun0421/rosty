...
Pending the next locked staffing or scheduling feature after completing the Assignment-confirmed notifications slice.

## Plan Doc

- Archive summary: `docs/development-plans/assignment-confirmed-notifications-slice/summary.md`
- Archive plan: `docs/development-plans/assignment-confirmed-notifications-slice/plan.md`

## Last Completed

Completed the Assignment-confirmed notifications slice:

- Added `supabase/migrations/20260321113000_assignment_confirmed_notifications.sql` so assignment confirmation enqueues employee inbox notifications.
- Updated `src/features/notifications/api/fetch-notifications.ts` so the fallback inbox also shows the assignment-confirmed notification type.
...
- The new notifications migrations are also not yet applied to the real Supabase project, so the live inbox cannot receive the new cancellation or assignment-confirmed notifications there yet.
...
- `corepack pnpm test`
- `corepack pnpm build`
- Completed the Assignment-confirmed notifications slice task on 2026-03-21.
