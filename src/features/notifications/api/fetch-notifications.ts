    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          body: `The schedule for ${createdSchedule?.eventDate ?? '2026-03-29'} · ${createdSchedule?.memo ?? 'Convention Hall banquet'} was updated. Review the latest details.`,
        ...
        {
          id: 'seed-notification-employee-7',
