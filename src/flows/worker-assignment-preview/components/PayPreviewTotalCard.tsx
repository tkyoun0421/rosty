  ...
  return (
    <Card aria-label="Total pay preview" className="bg-secondary/70">
      ...
      <CardContent className="space-y-2">
        {hasPendingPay ? (
          <>
            <p className="m-0 text-3xl font-semibold leading-none">Expected pay not available yet</p>
            <p className="m-0 text-sm text-muted-foreground">
              Hourly rate is still being assigned for at least one confirmed shift.
            </p>
          </>
        ) : (
          <>
