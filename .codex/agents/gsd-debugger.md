...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks C:/code/rosty/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/code/rosty/.codex/get-shit-done
                  → writes to C:/code/rosty/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "C:/code/rosty/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/code/rosty/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/code/rosty/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
