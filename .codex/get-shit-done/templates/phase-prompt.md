...
<!-- For checkpoint task examples and patterns, see @C:/code/rosty/.codex/get-shit-done/references/checkpoints.md -->
...
See `C:/code/rosty/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/code/rosty/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/code/rosty/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
