...
<execution_context>
@C:/code/rosty/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @C:/code/rosty/.codex/get-shit-done/workflows/add-tests.md end-to-end.
